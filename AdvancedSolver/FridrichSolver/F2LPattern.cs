...
namespace FridrichSolver
{
    public class F2LPattern : PatternTable
    {
        ...
        public override Dictionary<Pattern, Algorithm> Patterns => patterns;
        ...
        private void InitPatterns(CubeFlag r, CubeFlag f)
        {
            ...
            var correct =
                (r == CubeFlag.BackSlice && f == CubeFlag.RightSlice)
                || (f == CubeFlag.LeftSlice && r == CubeFlag.FrontSlice)
                    ? Orientation.Correct
            ...
            patterns = new Dictionary<Pattern, Algorithm>
              {
                ...
                {
                    Pattern.FromPatternItems(new List<PatternItem>()
                    {
